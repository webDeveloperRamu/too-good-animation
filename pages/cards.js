    ...
    <ReactLenis root>
      <div className="main w-full h-full" ref={container}>
        <section>
          ...
          <h2 className="text-[30px] font-semibold absolute left-1/2 top-1/4 transform -translate-x-1/2 -translate-y-1/2 capitalize">checkout to see the <Link href='/drawing-app' className="text-[#fff] underline underline-offset-8 decoration-4">Drawing App</Link></h2>
          <h2 className="text-[30px] font-semibold absolute left-1/2 top-1/3 transform -translate-x-1/2 -translate-y-1/2 capitalize"><Link href='/create-a-scene' className="text-[#fff] underline underline-offset-8 decoration-4"> 3D Scene using Threejs</Link>
          </h2>
        </section>
